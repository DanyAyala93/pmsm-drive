...
#define SQRT3         (float)1.732050807569  // Defines value for sqrt(3)
...
typedef struct
{
    ...
    uint8_t iterateHallAngle_counter; // Counter that increments when motor is stalled.
                                      // This is used to trigger the iteration of different angle estimates
    tagState sttData;
    uint16_t stateLth;
    uint32_t test32_1;
} tagHALLdata;
